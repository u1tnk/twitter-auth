...
Gem::Specification.new do |s|
  ...
  s.files = [
    "CHANGELOG.markdown",
     ...
     "config/routes.rb",
     "lib/generators/twitter_auth/USAGE",
     "lib/generators/twitter_auth/templates/migration.rb",
     "lib/generators/twitter_auth/templates/twitter_auth.yml",
     "lib/generators/twitter_auth/templates/user.rb",
     "lib/generators/twitter_auth/twitter_auth_generator.rb",
     "lib/twitter_auth.rb",
